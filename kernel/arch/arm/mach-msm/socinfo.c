...
const char *hw_platform[] = {
	...
	[HW_PLATFORM_FUSION] = "Fusion",
	[HW_PLATFORM_OEM] = "OEM",
        [HW_PLATFORM_QT] = "QT",
	[HW_PLATFORM_MTP_MDM] = "MTP_MDM",
        [HW_PLATFORM_MTP_MSM] = "MTP_MSM",
        [HW_PLATFORM_LIQUID] = "Liquid",
	[HW_PLATFORM_DRAGONBOARD] = "Dragonboard",
	[HW_PLATFORM_QRD_SKU1] = "QRD_SKU1",
	[HW_PLATFORM_QRD_SKU3] = "QRD_SKU3",
};
