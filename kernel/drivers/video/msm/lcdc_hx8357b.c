...
/* 
 ...
 Modified by Joe.111016, HX8357B
...
static int HX8357B_spi_init(void);
static void lcdc_HX8357B_intersleep(void);
static void lcdc_HX8357B_exitsleep(void);
static int lcdc_HX8357B_panel_off(struct platform_device *pdev);

static void HX8357B_spi_write(bool bReg, unsigned char uc);
static void write_reg_HX8357B(unsigned char uc);
static void write_data_HX8357B(unsigned char uc);
//static void read_reg_LG4573(unsigned char uc);
//static void read_data_LG4573(unsigned char *uc);
static void lcdc_HX8357B_set_backlight(struct msm_fb_data_type *mfd);


static void HX8357B_disp_on(void);
static void HX8357B_disp_on2(unsigned char polarity);
...
static void HX8357B_disp_on()
{
	HX8357B_disp_on2(0x0f);
}
...
static void HX8357B_disp_on2(unsigned char polarity)
{
...

    {
       ...
       write_reg_HX8357B(0x11); 
       mdelay(120); 

       write_reg_HX8357B(0xb4); 
       write_data_HX8357B(0x13);  //0x10 //0X11

        #if 0
        write_reg_HX8357B(0xb3); 
        write_data_HX8357B(0x0); 
        write_data_HX8357B(0x0); 
        write_data_HX8357B(0x0); 
        #endif

       write_reg_HX8357B(0xc0); 
       write_data_HX8357B(0x14); 
       write_data_HX8357B(0x3b); 
       write_data_HX8357B(0x00); 
       write_data_HX8357B(0x02); 
       write_data_HX8357B(0x11); 



       write_reg_HX8357B(0xc6); 
       write_data_HX8357B(0x9B);//82 //0x83 


       write_reg_HX8357B(0xc5); 
       write_data_HX8357B(0x0C); //0x0A//0x0f



       write_reg_HX8357B(0xc8);         
       write_data_HX8357B(0x00); 
       write_data_HX8357B(0x52); 
       write_data_HX8357B(0x37); 
       write_data_HX8357B(0x77); 
       write_data_HX8357B(0x0b); 
       write_data_HX8357B(0x1f); 
       write_data_HX8357B(0x04); 
       write_data_HX8357B(0x52); 
       write_data_HX8357B(0x77); 
       write_data_HX8357B(0x10); 
       write_data_HX8357B(0x0b); 
       write_data_HX8357B(0x00); 
            

                 
       write_reg_HX8357B(0xd0); 
       write_data_HX8357B(0x44); 
       write_data_HX8357B(0x41); 
       write_data_HX8357B(0x05); // 
       write_data_HX8357B(0xC2); // 
           
           
       write_reg_HX8357B(0xd1); 
       write_data_HX8357B(0x60);//0x63 
       write_data_HX8357B(0x17);      


            
       write_reg_HX8357B(0xd2); 
       write_data_HX8357B(0x05); 
       write_data_HX8357B(0x12); 

              
       write_reg_HX8357B(0xe9);   
       write_data_HX8357B(0x01); 

          
                 
       write_reg_HX8357B(0xea);   
       write_data_HX8357B(0x03); 
       write_data_HX8357B(0x00); 
       write_data_HX8357B(0x00); 


       write_reg_HX8357B(0xeb); 
       write_data_HX8357B(0x40); 
       write_data_HX8357B(0x54); 
       write_data_HX8357B(0x26); 
       write_data_HX8357B(0xdb); 


       write_reg_HX8357B(0xee); 
       write_data_HX8357B(0x18); 
       write_data_HX8357B(0x18); 
       write_data_HX8357B(0x18); 
       write_data_HX8357B(0x18); 


       write_reg_HX8357B(0xed); 
       write_data_HX8357B(0x10); 
       write_data_HX8357B(0x10); 
       write_data_HX8357B(0xa2); 
       write_data_HX8357B(0xa2); 
       write_data_HX8357B(0xa3); 
       write_data_HX8357B(0xa3); 
       write_data_HX8357B(0x0f); 
       write_data_HX8357B(0x0f);         
       write_data_HX8357B(0x10); 
       write_data_HX8357B(0x10);   
       write_data_HX8357B(0xae); 
       write_data_HX8357B(0xae);   
       write_data_HX8357B(0x10); 
       write_data_HX8357B(0xa3);   
       write_data_HX8357B(0x10); 
       ...
       write_reg_HX8357B(0x36); 
       write_data_HX8357B(0xc0);//c8 

       write_reg_HX8357B(0x29);        //Display On 
        mdelay(5); 
    }

	HX8357B_state.display_on = TRUE;

}

int HX8357B_spi_init(void)
{
	int result;
...
void write_reg_HX8357B(unsigned char uc)
{
	HX8357B_spi_write(TRUE, uc);
}

void write_data_HX8357B(unsigned char uc)
{
	HX8357B_spi_write(FALSE, uc);
}

void HX8357B_spi_write(bool bReg, unsigned char uc)
{
	int i;
...
void HX8357B_read_reg(byte data)
{
	int i;
...
void HX8357B_read_data(byte *data)
{
	int i;
	*data=0;
	LCDC2_SPI_CS_LOW;
...
#if 0
void HX8357B_spi_read(unsigned char reg, unsigned char *puc, unsigned char c /* count to read */)
{
	int i;
	int c1;
...
static void lcdc_HX8357B_intersleep(void)
{
   	printk(KERN_INFO "LCDC_HX8357B:intersleep\n");
    write_reg_HX8357B(0x28);
	write_reg_HX8357B(0x10);
	mdelay(120);
...
#if 1
	//power_vreg_gp6(0);	
	//HX8357B_disp_reset(); //modify by Joe 120405
#endif
...
static int lcdc_HX8357B_panel_on(struct platform_device *pdev)
{
    ...
    printk(KERN_ERR "%s, initialized:%d\n", __func__, HX8357B_state.disp_initialized);

	if (!HX8357B_state.disp_initialized) {
		ret = HX8357B_spi_init();
		if(ret) {
		...
		//HX8357B_disp_reset();//modify by Joe 120509
		HX8357B_disp_on();

		HX8357B_state.disp_powered_up = TRUE;
		HX8357B_state.disp_initialized = TRUE;
        return 0;
	}

	if (!HX8357B_state.disp_powered_up ) {
	   lcdc_HX8357B_exitsleep();
	   HX8357B_state.disp_powered_up = TRUE;
	}
	return 0;
}
...
void lcdc_HX8357B_enable_gp_clock(int on)
{
	static int count = 0;
	...
	if (bl_level > 0) {
		...
		if(bl_level > 0) {
			...
			*/
			...
			lcdc_HX8357B_enable_gp_clock(0); //clk_disable(gp_clk);
		}	
#endif
}
...
static int detect_panel_hx8357b(void)
{
    //int result;
    #if 0
    char deviceID[6];
	HX8357B_spi_init();	// config in lk ??
    ...
    #endif
    gpio_request(LCDC2_ID,"hx8357b id_in");
    ...
    printk(KERN_ERR "%s gpio_get_value is low\n", __func__);
    return 0;
}


static int __devinit HX8357B_probe(struct platform_device *pdev)
{
    //char deviceID[6];
	int result = 0;
    //int rc = 0;
...
//	power_vreg_gp6(1);  // powered up in lk.  we call this for record vreg count only.
    ...
    result	=gpio_request(BACKLIGHT_GPIO, "hx8357b backlight");
...
#define SZ_THIS_MODULE_NAME	"lcdc_wvga_HX8357B"		//"lcdc_gordon_vga"
...
static struct msm_fb_panel_data HX8357B_panel_data = {
	...
	.set_backlight = lcdc_HX8357B_set_backlight,
};
...
int late_lcdc_HX8357B_panel_init(void)
{
	int ret;
	...
	pinfo->bpp = 18;
	pinfo->fb_num = 1;
	pinfo->clk_rate = 11565000;//10240000;//13107000;//13653000;//8000000;//8000000;//27306667;//28086857; 25M: 24576000; // HX8357B wanna 27M
#if defined(BACKLIGHT_USING_PMIC__LCD_DRV_N)
...
EXPORT_SYMBOL(late_lcdc_HX8357B_panel_init);
