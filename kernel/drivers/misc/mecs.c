...
/*=========================================
2011/12/02-------Long Weicai----------Ecompass bug fix
...
static long  ecs_ctrl_ioctl(/*struct inode *inode, */struct file *file, 
...
static struct file_operations ecs_ctrl_fops = {
	...
	.unlocked_ioctl		= ecs_ctrl_ioctl,//modify by jz1560
};
...
static long ecs_ctrl_ioctl(/*struct inode *inode, */struct file *file, //modify by jz1560
	unsigned int cmd, unsigned long arg)
{
