...
typedef struct {
	uint16_t addr;
	uint16_t data;
} S5K5CAGA_WREG, *PS5K5CAGA_WREG;

#define S5K5CAG_WriteTABLE(pTbl)     s5k5cag_i2c_write_table(pTbl,sizeof(pTbl)/sizeof(pTbl[0]),10)


S5K5CAGA_WREG preview_s5k5cag_reg[]=
{
{0xFCFC, 0xD000},
...
{0x002A, 0x0F70},   
{0x0F12, 0x0032}, //#9 Brightness adjust	0x0040},	 //36 //TVAR_ae_BrAve  //ae Target//
{0x002A, 0x0530},   	                                                    
...
{0x0F12, 0x0101},  //0101  //0102
	...
	// Set input CLK // 24MHz
	{ 0x002A, 0x01CC}, 
	{ 0x0F12, 0x5DC0},  //5FB4 // #REG_TC_IPRM_InClockLSBs mclk=24Mhz
	{ 0x0F12, 0x0000},  // #REG_TC_IPRM_InClockMSBs
	{ 0x002A, 0x01EE}, 
	{ 0x0F12, 0x0000},  // #REG_TC_IPRM_UseNPviClocks // Number of PLL setting
	{ 0x0F12, 0x0002},
	// Set system CLK // 42MHz
	{ 0x002A, 0x01F6}, 
	{ 0x0F12, 0x2EE0},  //34BC //2710	//2904	//2BF2 // #REG_TC_IPRM_OpClk4KHz_0
	// Set pixel CLK // 60MHz {0x3A98}
	{ 0x0F12, 0x3A88},  //157C //3A88 // #REG_TC_IPRM_MinOutRate4KHz_0 0x157C
	{ 0x0F12, 0x3AA8},  //157C //3AA8 // #REG_TC_IPRM_MaxOutRate4KHz_0 0x157C

	{ 0x0F12, 0x2EE0},  //3A88 	//2904	//2BF2 // #REG_TC_IPRM_OpClk4KHz_1
	// Set pixel CLK // 60MHz {0x3A98}
	{ 0x0F12, 0x4640},  //0x1194}0x0FA0; //157C //3A88 // #REG_TC_IPRM_MinOutRate4KHz_1
	{ 0x0F12, 0x4660},  //157C //3AA8 // #REG_TC_IPRM_MaxOutRate4KHz_1
	// Update PLL
	{ 0x002A, 0x0208}, 
	...
	// # Foramt : YUV422
	// # Size: VGA
	// # FPS : 15~20fps for normal mode
	//================================================================================================
	{ 0x002A, 0x026C}, 
	{ 0x0F12, 0x0320},  //0400 //#REG_0TC_PCFG_usWidth//1024   //800*600
	{ 0x0F12, 0x0258},  //0300 //#REG_0TC_PCFG_usHeight //768    026E 
	{ 0x0F12, 0x0005},  //#REG_0TC_PCFG_Format            0270
	{ 0x0F12, 0x3aa8},  //157C //3AA8 //#REG_0TC_PCFG_usMaxOut4KHzRate  0272
	{ 0x0F12, 0x3a88},  //157C //3A88 //#REG_0TC_PCFG_usMinOut4KHzRate  0274
	...
	{ 0x0F12, 0x03c0},  //01E0 //#REG_0TC_PCFG_usJpegPacketSize
	...
	{ 0x0F12, 0x03e8},  //03E8 //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //10fps
	{ 0x0F12, 0x01F4},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //20fps
	...
	{ 0x0F12, 0x0003}, //#9 0x0000},  //#REG_0TC_PCFG_uPrevMirror
	{ 0x0F12, 0x0003}, //#9 0x0000},  //#REG_0TC_PCFG_uCaptureMirror
	...
	// # Foramt : YUV422
	// # Size: VGA
	// # FPS : 20~10fps for night mode
	//================================================================================================
	{ 0x002A, 0x029C}, 
	{ 0x0F12, 0x0400},  //0400 //#REG_0TC_PCFG_usWidth//1024   
	{ 0x0F12, 0x0300},  //0300 //#REG_0TC_PCFG_usHeight //768    026E 
	{ 0x0F12, 0x0005},  //#REG_0TC_PCFG_Format            0270
	{ 0x0F12, 0x3AA8},  //157C //3AA8 //#REG_0TC_PCFG_usMaxOut4KHzRate  0272
	{ 0x0F12, 0x3A88},  //157C //3A88 //#REG_0TC_PCFG_usMinOut4KHzRate  0274
	{ 0x0F12, 0x0100},  //#REG_0TC_PCFG_OutClkPerPix88    0276
	...
	{ 0x0F12, 0x0000},  //#REG_0TC_PCFG_usFrTimeType
	{ 0x0F12, 0x0001},  //1 //#REG_0TC_PCFG_FrRateQualityType
	{ 0x0F12, 0x07D0},  //03E8 //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //5fps
	{ 0x0F12, 0x03E8},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //10fps
	{ 0x0F12, 0x0000},  //#REG_0TC_PCFG_bSmearOutput
	{ 0x0F12, 0x0000},  //#REG_0TC_PCFG_sSaturation
	{ 0x0F12, 0x0000},  //#REG_0TC_PCFG_sSharpBlur
	{ 0x0F12, 0x0000},  //#REG_0TC_PCFG_sColorTemp
	...
	{ 0x0F12, 0x0003}, // #9 0x0000},  //#REG_0TC_PCFG_uCaptureMirror
	{ 0x0F12, 0x0003}, // #9 0x0000},  //#REG_0TC_PCFG_uRotation

//================================================================================================
// SET PREVIEW CONFIGURATION_2	 
// # Foramt : YUV422
// # Size: VGA
// # FPS : 20fps for night mode


//================================================================================================

#if 0 // #9 new add  fix to 20fps for preview mode
{ 0x002A, 0x02CC}, 
{ 0x0F12, 0x0400},	//0400 //#REG_0TC_PCFG_usWidth//1024   
{ 0x0F12, 0x0300},	//0300 //#REG_0TC_PCFG_usHeight //768	 026E 
{ 0x0F12, 0x0005},	//#REG_0TC_PCFG_Format			  0270
...
{ 0x0F12, 0x0000},	//#REG_0TC_PCFG_usFrTimeType
{ 0x0F12, 0x0001},	//1 //#REG_0TC_PCFG_FrRateQualityType
{ 0x0F12, 0x01F4},	//03E8 //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //5fps
{ 0x0F12, 0x01F4},	//01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //10fps
{ 0x0F12, 0x0000},	//#REG_0TC_PCFG_bSmearOutput
{ 0x0F12, 0x0000},	//#REG_0TC_PCFG_sSaturation
{ 0x0F12, 0x0000},	//#REG_0TC_PCFG_sSharpBlur
{ 0x0F12, 0x0000},	//#REG_0TC_PCFG_sColorTemp
...
{ 0x0F12, 0x0800},  //0800 //#REG_1TC_CCFG_usWidth 
{ 0x0F12, 0x0600},  //0600 //#REG_1TC_CCFG_usHeight
{ 0x0F12, 0x0005},  //#REG_0TC_CCFG_Format//5:YUV9:JPEG 
{ 0x0F12, 0x4660},  //157C //3AA8 //#REG_0TC_CCFG_usMaxOut4KHzRate
{ 0x0F12, 0x4640},  //157C //3A88 //#REG_0TC_CCFG_usMinOut4KHzRate
{ 0x0F12, 0x0100},  //#REG_0TC_CCFG_OutClkPerPix88
{ 0x0F12, 0x0800},  //#REG_0TC_CCFG_uMaxBpp88 
{ 0x0F12, 0x0052},  //0052 //#REG_0TC_CCFG_PVIMask 
{ 0x0F12, 0x0050},  //#REG_0TC_CCFG_OIFMask   
{ 0x0F12, 0x03c0},  //01E0 //#REG_0TC_CCFG_usJpegPacketSize
{ 0x0F12, 0x0320},  //08fc //#REG_0TC_CCFG_usJpegTotalPackets
{ 0x0F12, 0x0001},  //#REG_0TC_CCFG_uClockInd 
{ 0x0F12, 0x0000},  //#REG_0TC_CCFG_usFrTimeType
{ 0x0F12, 0x0002},  //2 //#REG_0TC_CCFG_FrRateQualityType 
{ 0x0F12, 0x03E8},  //029A //0535 //#REG_0TC_CCFG_usMaxFrTimeMsecMult10 //10fps
{ 0x0F12, 0x03E8},  //#REG_0TC_CCFG_usMinFrTimeMsecMult10 //10fps 
...
{ 0x0F12, 0x0050},  //#REG_0TC_CCFG_OIFMask   
{ 0x0F12, 0x03c0},  //01E0 //#REG_0TC_CCFG_usJpegPacketSize
{ 0x0F12, 0x0000},  //08fc //#REG_0TC_CCFG_usJpegTotalPackets
{ 0x0F12, 0x0001},  //#REG_0TC_CCFG_uClockInd 
{ 0x0F12, 0x0000},  //#REG_0TC_CCFG_usFrTimeType
{ 0x0F12, 0x0002},  //2 //#REG_0TC_CCFG_FrRateQualityType 
{ 0x0F12, 0x07D0},  //029A //0535 //#REG_0TC_CCFG_usMaxFrTimeMsecMult10 //5fps
...
S5K5CAGA_WREG preview_tbl_1[] =
{

	// preview 
	{0x0028,0x7000},
	{0x002A,0x023C}, 
	{0x0F12,0x0000}, //#9 fix to 20fps: 0x0002, 20~10fps: 0x0000	 // #REG_TC_GP_ActivePrevConfig
	{0x002A,0x0240}, 
...
//contrast register map begin
S5K5CAGA_WREG s5k5cag_contrast_lv0_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0xFF82},
};
S5K5CAGA_WREG s5k5cag_contrast_lv1_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0xFF9B},
};
S5K5CAGA_WREG s5k5cag_contrast_lv2_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0xFFB4},
};
S5K5CAGA_WREG s5k5cag_contrast_lv3_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0xFFD8},
};
S5K5CAGA_WREG s5k5cag_contrast_default_lv4_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0x0000},
};
S5K5CAGA_WREG s5k5cag_contrast_lv5_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0x0019},
};
S5K5CAGA_WREG s5k5cag_contrast_lv6_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0x0032},
};
S5K5CAGA_WREG s5k5cag_contrast_lv7_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0x005a},
};
S5K5CAGA_WREG s5k5cag_contrast_lv8_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x020E},
{0x0F12,0x007d},
};
//contrast register map end

//saturation register map begin
S5K5CAGA_WREG s5k5cag_saturation_lv0_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0xFF82},
};
S5K5CAGA_WREG s5k5cag_saturation_lv1_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0xFF9B},
};
S5K5CAGA_WREG s5k5cag_saturation_lv2_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0xFFB4},
};
S5K5CAGA_WREG s5k5cag_saturation_lv3_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0xFFCD},
};
S5K5CAGA_WREG s5k5cag_saturation_default_lv4_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0x0000},
};
S5K5CAGA_WREG s5k5cag_saturation_lv5_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0x0019},
};
S5K5CAGA_WREG s5k5cag_saturation_lv6_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0x0032},
};
S5K5CAGA_WREG s5k5cag_saturation_lv7_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0x004B},
};
S5K5CAGA_WREG s5k5cag_saturation_lv8_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0210},
{0x0F12,0x007D},
};
//saturation register map end

//sharpness register map begin
S5K5CAGA_WREG s5k5cag_sharpness_lv0_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0xFF82},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv1_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0xFF9B},
};
S5K5CAGA_WREG s5k5cag_sharpness_default_lv2_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0xFFB4},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv3_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0xFFE6},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv4_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0x0000},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv5_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0x0019},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv6_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0x0032},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv7_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0x004B},
};
S5K5CAGA_WREG s5k5cag_sharpness_lv8_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0212},
{0x0F12,0x007D},
};
//sharpness register map end

//iso register map begin
S5K5CAGA_WREG s5k5cag_iso_type_auto[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
S5K5CAGA_WREG s5k5cag_iso_type_100[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
S5K5CAGA_WREG s5k5cag_iso_type_200[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
S5K5CAGA_WREG s5k5cag_iso_type_400[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
S5K5CAGA_WREG s5k5cag_iso_type_800[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
S5K5CAGA_WREG s5k5cag_iso_type_1600[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
...
//iso register map end

//effect register map begin
S5K5CAGA_WREG s5k5cag_effect_normal_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
S5K5CAGA_WREG s5k5cag_effect_mono_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
S5K5CAGA_WREG s5k5cag_effect_sepia_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
S5K5CAGA_WREG s5k5cag_effect_negative_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
S5K5CAGA_WREG s5k5cag_effect_reddish_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002a,0x021e},
{0x0F12,0x0000},
...
S5K5CAGA_WREG s5k5cag_effect_greenish_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002a,0x021e},
{0x0F12,0x0000},
...
S5K5CAGA_WREG s5k5cag_effect_bluish_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002a,0x021e},
{0x0F12,0x0000},
...
S5K5CAGA_WREG s5k5cag_effect_bw_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
S5K5CAGA_WREG s5k5cag_effect_solarize_tbl[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x04D2},
{0x0F12,0x077F},
...
//effect register map end

S5K5CAGA_WREG s5k5cag_scene_preview_normal_tbl[] = {
  { 0x002A, 0x023C}, 
...
S5K5CAGA_WREG s5k5cag_scene_preview_night_tbl[] = {
  { 0x002A, 0x023C}, 
...
S5K5CAGA_WREG s5k5cag_scene_capture_normal_tbl[] = {
  { 0x0028, 0x7000}, 
	{ 0x002a, 0x0244},  //#REG_TC_GP_ActiveCapConfig    
	{ 0x0F12, 0x0000},                                  
	{ 0x002a, 0x0230},  //#REG_TC_GP_NewConfigSync      
...
S5K5CAGA_WREG s5k5cag_scene_capture_night_tbl[] = {
  { 0x0028, 0x7000}, 
	{ 0x002a, 0x0244},  //#REG_TC_GP_ActiveCapConfig    
	{ 0x0F12, 0x0001},                                  
	{ 0x002a, 0x0230},  //#REG_TC_GP_NewConfigSync      
...
S5K5CAGA_WREG s5k5cag_rawdata_tbl[] = {
  { 0x0028, 0x7000},       
	{ 0x002a, 0x0270},       
	{ 0x0F12, 0x0005},       
	{ 0x002a, 0x0362},       
...
S5K5CAGA_WREG s5k5cag_rawdata_rebacktoyuv_tbl[] = {
  { 0x0028, 0x7000},       
	{ 0x002a, 0x0270},       
	{ 0x0F12, 0x0005},       
	{ 0x002a, 0x0362},       
